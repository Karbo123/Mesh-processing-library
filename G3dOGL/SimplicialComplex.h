...
class ISimplex : noncopyable {
 ...
 public:
  ...
  void add_quadric_(Simplex q, const Simplex a, float w = 1.0) {
  ...
  void weight_quadric_(Simplex q, float w) {
  ...
  void compute_native_quadric_() {
    ...
    if (dim == 0) {
      ...
      if (_weighting_quadric >= 0) {
        weight_quadric_(this, _weighting_quadric);
      }
      ...
      // weighted by length
      if (_weighting_quadric >= 0) {
        weight_quadric_(this, mag(p1 - p0) * _weighting_quadric);
      }
      ...
      if (_weighting_quadric >= 0) {
        ...
        weight_quadric_(this, scaled_area);
      }
    }
  }
  ...
  void aggregate_() {
    ...
    for (auto s : get_star()) {
      ...
      if (dim == 0) {
        ...
        add_quadric_(this, s, 1.0f / (dim + 1));
      }
    }
  }
#endif
